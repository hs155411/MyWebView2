...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchDates = new ArrayList<String>();
        dataAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_dropdown_item_1line, searchDates);
    ...
    private void addHistoryData(String data) {
        if (!searchDates.contains(data))
            searchDates.add(0, data);
        if (searchDates.size() > 5)
            searchDates.remove(5);
    }
}
